<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="uploadfiles.aspx.cs" Inherits="Client_Default" %>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <div class="form-group">
                            <asp:Label ID="Label3" runat="server" Text="You can upload files of your project only after accepting quotation!!!" CssClass="control-label col-md-7 " font-size="16px" ForeColor="#0099FF" style="font-family: Arial; font-weight: bold"></asp:Label>
                 </div>
                 </br>
             <div class="form-group">
...
%>
    ...
    {%>
     ...
     %>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eeeConnectionString %>" ProviderName="<%$ ConnectionStrings:eeeConnectionString.ProviderName %>" SelectCommand="SELECT work_request.work_id, work_request.work_name FROM work_request INNER JOIN workallot ON work_request.work_id = workallot.w_id WHERE (work_request.status = @status) AND work_request.client_id=@clid">
                    <SelectParameters>
