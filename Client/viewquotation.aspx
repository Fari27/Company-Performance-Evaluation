<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="viewquotation.aspx.cs" Inherits="Client_Default" %>
     ...
     %>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eeeConnectionString %>" ProviderName="<%$ ConnectionStrings:eeeConnectionString.ProviderName %>" SelectCommand="SELECT  work_id, work_name  FROM work_request  WHERE (status = @status) and client_id=@cid">
                            <SelectParameters>
                 ...
                 <div class="col-md-6 col-md-offset-3">
                    <asp:GridView ID="GridView1" CssClass="table table-hover table-responsive" runat="server" AutoGenerateColumns="False" DataKeyNames="file_id" DataSourceID="SqlDataSource2" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:ButtonField CommandName="vw" Text="Accept" FooterStyle-BackColor="#0099FF" ButtonType="Button" ControlStyle-BackColor="#0099ff" ControlStyle-CssClass="btn" ControlStyle-ForeColor="#ffffff" ControlStyle-Font-Size="14px"/>
                             <asp:ButtonField CommandName="rj" Text="Reject" FooterStyle-BackColor="#0099FF" ButtonType="Button" ControlStyle-BackColor="#0099ff" ControlStyle-CssClass="btn" ControlStyle-ForeColor="#ffffff" ControlStyle-Font-Size="14px"/>
                        </Columns>
                  ...
                  <div class="form-group">
                      <div class="col-md-6 col-md-offset-1">
                          <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn-info btn-link" font-size="16px" ForeColor="#0099FF" style="font-family: Arial; font-weight: bold" OnClick="LinkButton1_Click">Accepted Quotation</asp:LinkButton>
