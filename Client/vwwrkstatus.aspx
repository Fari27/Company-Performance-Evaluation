<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="vwwrkstatus.aspx.cs" Inherits="Client_Default" %>
    ...
    <script>
        ...
        function selctmodulestatus() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "../Client/vwwrkstatus.aspx/moduledtls",
                data: "{'wid':'" + wid + "'}",
        ...
        function selectworkstatus() {
          ...
          //  $("#cnt").html('');
            ...
            $.ajax({
                ...
                type: "POST",
                url: "../Client/vwwrkstatus.aspx/workcompleted",
                data: "{'wid':'" + wid + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
         <h3 class="page-header text-center"><strong> VIEW WORK STATUS</strong></h3>
        
        <div class="jumbotron">
                       <div class="form-horizontal">

                       <div class="form-group">
                            <asp:Label ID="Label1" runat="server" Text="You can view status of your project only after  work allocation!!!" CssClass="control-label col-md-7 " font-size="16px" ForeColor="#0099FF" style="font-family: Arial; font-weight: bold"></asp:Label>
                 </div>
                 </br>
                           <div class="form-group">
                 ...
                 <div class="col-md-6">
                     ...
                     <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:eeeConnectionString %>" ProviderName="<%$ ConnectionStrings:eeeConnectionString.ProviderName %>" SelectCommand="SELECT work_request.work_id, work_request.work_name FROM workallot INNER JOIN work_request ON workallot.w_id = work_request.work_id  where work_request.client_id =@plid">
                         <SelectParameters>
