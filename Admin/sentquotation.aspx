<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="sentquotation.aspx.cs" Inherits="Admin_Default" %>
     ...
     %>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eeeConnectionString %>" ProviderName="<%$ ConnectionStrings:eeeConnectionString.ProviderName %>" SelectCommand="SELECT  work_id, work_name  FROM work_request">
                            <SelectParameters>
                ...
                <div class="form-group">
                 <div class="col-md-6 col-md-offset-3">
                    <asp:GridView ID="GridView1" CssClass="table table-hover table-responsive" Width="500px" runat="server" AutoGenerateColumns="False" DataKeyNames="file_id" DataSourceID="SqlDataSource2"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
