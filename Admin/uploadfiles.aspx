<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="uploadfiles.aspx.cs" Inherits="Client_Default" %>
    ...
    {%>
     ...
     %>
                 ...
                 <asp:textbox runat="server"  ID="txttoadd" CssClass="form-control" placeholder="Enter to address" required="required" type="email"></asp:textbox>
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList1"  ValidationGroup="a"  ErrorMessage="*" ForeColor="Red" InitialValue="0"></asp:RequiredFieldValidator>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eeeConnectionString %>" ProviderName="<%$ ConnectionStrings:eeeConnectionString.ProviderName %>" SelectCommand="SELECT work_request.work_id, work_request.work_name FROM work_request WHERE  (status = @status)">
                    <SelectParameters>
                 ...
                 <asp:textbox runat="server" CssClass="form-control"  ID="txtmessage" placeholder="Enter message" required="required"></asp:textbox>
                  ...
                  <div class="col-md-6">
                  <asp:fileupload id="FileUpload1" runat="server" CssClass="form-control" required="required"></asp:fileupload>
                  </div>
