<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="notifications.aspx.cs" Inherits="Admin_Default" %>
...
%>
                    <div class="alert alert-success alert-dismissable">
                        ...
                        <a href="notification.aspx" class="close" data-dismiss="alert" aria-label="close">&times</a>
    ...
    {%>
     ...
     %>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-6">
                         <asp:DropDownList ID="DropDownList1"  runat="server" DataSourceID="SqlDataSource1" CssClass="form-control" DataTextField="dept_name" DataValueField="dept_id" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"><asp:ListItem Value="0">--Select--</asp:ListItem></asp:DropDownList>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-6">
                         <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" CssClass="form-control" DataTextField="position_name" DataValueField="pid"><asp:ListItem Value="0">--Select--</asp:ListItem></asp:DropDownList>
                    ...
                    <div class="col-md-6">
                        <asp:TextBox ID="txtsub" CssClass="form-control" runat="server" placeholder="Enter subject" required="required"></asp:TextBox>
             ...
             <div class="col-md-6 col-md-offset-3">
                 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn-info btn-link" font-size="16px" Visible="false" ForeColor="#0099FF" style="font-family: Arial; font-weight: bold" OnClick="LinkButton1_Click">Sent notifications</asp:LinkButton>
            <asp:HyperLink ID="HyperLink1" font-size="16px" ForeColor="#0099FF" CssClass="btn-info btn-link"  runat="server" NavigateUrl="~/Admin/notification.aspx">Sent notifications</asp:HyperLink>
                  </div>
