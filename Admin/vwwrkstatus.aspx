<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="vwwrkstatus.aspx.cs" Inherits="Projectleader_Default" %>
    ...
    <script>
        ...
        function selctmodulestatus() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "../Admin/vwwrkstatus.aspx/moduledtls",
                data: "{'wid':'" + wid + "'}",
