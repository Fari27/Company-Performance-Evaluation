<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="changepassword.aspx.cs" Inherits="Admin_Default" %>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <asp:Button ID="Button1" CssClass="btn btn-info form-control" runat="server" Text="Submit" ValidationGroup="a" OnClick="Button1_Click" />
