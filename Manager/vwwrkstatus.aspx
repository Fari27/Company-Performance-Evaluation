<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Manager.master" AutoEventWireup="true" CodeFile="vwwrkstatus.aspx.cs" Inherits="Projectleader_Default" %>
    ...
    <script>
        ...
        function selctmodulestatus() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "../Manager/vwwrkstatus.aspx/moduledtls",
                data: "{'wid':'" + wid + "'}",
        ...
        function selectworkstatus() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "../Manager/vwwrkstatus.aspx/workcompleted",
                data: "{'wid':'" + wid + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="form-group">
                 ...
                 <div class="col-md-6">
                     ...
                     <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:eeeConnectionString %>" ProviderName="<%$ ConnectionStrings:eeeConnectionString.ProviderName %>" SelectCommand="SELECT work_request.work_id, work_request.work_name FROM workallot INNER JOIN work_request ON workallot.w_id = work_request.work_id WHERE (work_request.status = @status) AND (workallot.manager_id = @plid)">
                         <SelectParameters>
                             <asp:Parameter DefaultValue="allocated" Name="status" />
                             <asp:SessionParameter DefaultValue="" Name="plid" SessionField="user" />
                         </SelectParameters>
                     </asp:SqlDataSource>
...
<div class="form-group">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <asp:Button ID="Button1"  CssClass="btn btn-info form-control" runat="server"  
                            Text="Update project status" OnClick="Button1_Click" style="margin-bottom: 0" 
                           />
